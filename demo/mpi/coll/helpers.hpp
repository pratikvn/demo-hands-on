...
namespace kamping {
/// @brief Print all elements in a container, prefixed with the rank of the
/// current PE.
...
template <template <typename...> typename ContainerType,
          ...
          typename... Plugins,
          typename T>
void print_result(T const& result,
                  Communicator<ContainerType, Plugins...> const& comm)
{
...
/// @tparam Communicator Type of communicator (has to be a KaMPIng
/// communicator).
